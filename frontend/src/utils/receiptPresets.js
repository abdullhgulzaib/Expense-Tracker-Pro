/**
 * Generates realistic SVG data URLs for Pakistani payment receipts
 * for quick preview, demonstration and testing in SplitVault.
 */
...
export const generateSampleReceipt = (type, { amount, recipient, tid, date }) => {
  ...
  if (type === 'JazzCash') {
    const svg = `
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 400 620" width="100%" height="100%">
      <defs>
      ...
      <g transform="translate(40, 305)">
        ...
        <text x="0" y="84" fill="#9CA3AF" font-family="system-ui, sans-serif" font-size="13">Date & Time</text>
        <text x="320" y="84" fill="#E4E4E7" font-family="system-ui, sans-serif" font-size="13" text-anchor="end">${txDate}</text>

        <text x="0" y="126" fill="#9CA3AF" font-family="system-ui, sans-serif" font-size="13">Fee & Taxes</text>
        ...
        <text x="320" y="168" fill="#E4E4E7" font-family="system-ui, sans-serif" font-size="13" text-anchor="end">JazzCash App</text>
      </g>
  ...
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 400 620" width="100%" height="100%">
    ...
    <g transform="translate(200, 545)">
      ...
      <text x="0" y="7" fill="#38BDF8" font-family="system-ui, sans-serif" font-size="11" font-weight="600" text-anchor="middle">🛡️ 100% Cryptographically Settled</text>
    </g>
